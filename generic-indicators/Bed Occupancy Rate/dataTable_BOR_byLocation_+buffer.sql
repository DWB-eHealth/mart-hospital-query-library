...
* Customization: inpatient location names (row 22), buffer bed location name (rew 34), out-of-service tag name (row 45), out-of-service bed locations (row 47), bed count locations (row 110), reporting period unit (weeks, months, etc.) (row 128)*/
