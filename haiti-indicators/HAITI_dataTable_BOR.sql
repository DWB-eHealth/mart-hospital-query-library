...
* Customization: inpatient visit type name (row 21), missing bed tag name (row 32), reporting period unit (weeks, months, etc.) (row 94)*/
...
/*The visit_type_name should be set to the visit type name used for inpatient visits with the EMR.*/
	WHERE pvdd.visit_type_name = 'Hospitalisation'
