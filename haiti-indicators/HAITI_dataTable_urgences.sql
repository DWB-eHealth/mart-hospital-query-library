/*ABOUT
 * The visits data table is for counting the number of emergency visits recorded in the EMR. 
 * Each row of the query represents a visit.
 
 * Variables: patient id, visit type, visit start date, visit end date, length of stay (days), sex, address fields, age (not yet available)
